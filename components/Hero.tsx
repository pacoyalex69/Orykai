...
export default function Hero() {
  ...
  return (
    <section
      ref={containerRef}
      id="home"
      className="relative min-h-[100svh] w-full overflow-hidden bg-[#050505] text-[#f4f0e5]"
    >
      ...
      <div className="relative z-10 flex min-h-[100svh] w-full flex-col justify-end px-4 pb-6 pt-24 sm:px-6 md:px-12 md:pb-8">
        <div className="relative mt-20 max-w-7xl md:mt-28">
          ...
          <h1 className="hero-title-shadow font-heading text-7xl font-black uppercase leading-none text-white sm:text-8xl md:text-9xl lg:text-[7.75rem] 2xl:text-[9.25rem]">
          ...
          <div className="hero-fade mt-6 grid gap-8 md:mt-8 md:grid-cols-[1fr_auto] md:items-start">
            <div className="max-w-3xl">
              <p className="font-serif-italic text-2xl leading-snug text-[#f4f0e5] md:text-2xl xl:text-3xl">
                "{siteContent.brand.heroQuote}"
              </p>
              <div className="mt-6 hidden grid-cols-1 gap-3 text-sm uppercase text-white/72 sm:grid-cols-2 md:grid md:grid-cols-4">
